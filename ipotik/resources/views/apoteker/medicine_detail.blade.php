                        ...
                        <div class="row row-cols-s2 g-2">
                            ...
                            <div class="col-12 col-lg-9">
                                ...
                                <div class="card shadow-sm">
                                    <div class="card-body">
                                        <p class="card-text-title">Tambah Ke Keranjang Pasien</p>
                                        <hr>
                                        <form action="{{ route('verifikasi.keranjang.store', ['transaction' => $transaction->id, 'medicine' => $medicine->id]) }}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-2 text-end d-flex align-items-center justify-content-end">
                                                    <label for="quantity" class="">Nama :</label>
                                                </div>
                                                <div class="col-10">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-2 text-end d-flex align-items-center justify-content-end">
                                                    <label for="quantity" class="">Resep :</label>
                                                </div>
                                                <div class="col-10">
