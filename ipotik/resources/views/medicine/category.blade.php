                    ...
                    <div class="row justify-content-start mt-3">
                        <div class="col-12 mb-3 d-inline">
                            ...
                            @if (Auth::check() && Auth::user()->role == 'admin')
                                <a href="{{ route('medicine.create') }}" class="btn btn-success ms-3">Tambah Obat</a>
                            @endif
                        </div>
                    </div>
                    <div class="row justify-content-start mt-3">
                        ...
                        <div class="col-12 col-md-4 col-lg-3 mb-3 d-flex justify-content-center">
                            <div class="card w-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('medicine.show', $medicine->id) }}" class="btn btn-primary w-100 bg-primary border-0 mb-2">Detail Obat</a>
                                    @if (Auth::check() && Auth::user()->role == 'admin')
                                        <a href="{{ route('medicine.edit', $medicine->id) }}" class="btn btn-danger w-100">Edit</a>
                                    @endif
                                </div>
                            </div>
                        </div>
